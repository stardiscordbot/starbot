...
var createMaster = require('./master/create');
var loadMaster = require('./master/load');
var utilMaster = require('./master/util');
				...
				new Promise(function (resolve, reject) {
					return __awaiter(void 0, void 0, void 0, function () {
						...
						return __generator(this, function (_a) {
							switch (_a.label) {
							case 0:
								return [4 /*yield*/, readdirAsync(backups)];
							case 1:
								files = _a.sent();
								file = files
									.filter(function (f) {
			...
			return __generator(this, function (_a) {
				getBackupData(backupID)
					.then(function (backupData) {
						var size = fs_1.statSync(
							'' + backups + path_1.sep + backupID + '.json'
						...
						return __generator(this, function (_j) {
							...
							case 1:
								...
								backupData = {
									...
									tantodecanal: guild.channels.cache.size,
									...
									guildID: guild.id,
									id:
											(_h = options.backupID) !== null &&
											_h !== void 0
												? _h
												: discord_js_1.SnowflakeUtil.generate(
													Date.now()
												  ),
								};
								if (!guild.iconURL())
							...
							case 14:
								...
								return [
									4 /*yield*/,
									createMaster.getEmojis(guild, options),
								];
							case 15:
								// Backup emojis
								_f.emojis = _j.sent();
					...
					return __awaiter(void 0, void 0, void 0, function () {
						...
						return __generator(this, function (_b) {
							...
							case 7:
								...
								return [
									4 /*yield*/,
									loadMaster.conf(guild, backupData),
								];
							case 8:
								// Restore guild configuration
								_b.sent();
								...
								return [
									4 /*yield*/,
									loadMaster.roles(guild, backupData),
								];
							case 9:
								// Restore guild roles
								_b.sent();
							...
							case 10:
								...
								return [
									4 /*yield*/,
									loadMaster.afk(guild, backupData),
								];
							case 11:
								// Restore afk channel and timeout
								_b.sent();
								...
								return [
									4 /*yield*/,
									loadMaster.emojis(guild, backupData),
								];
							case 12:
								// Restore guild emojis
								_b.sent();
								...
								return [
									4 /*yield*/,
									loadMaster.bans(guild, backupData),
								];
							case 13:
								// Restore guild bans
								_b.sent();
