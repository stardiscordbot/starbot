...
module.exports.run = (client, message, args) => {
    if (!config.dev.some(a => message.author.id === a)) return message.channel.send('Apenas desenvolvedores / moderadores do bot podem utilizar este comando!')
  const id = args[0]
  ...
  if(id == "422535241211707393" || id == "717766639260532826" || id == "672652538880720896") return message.channel.send(`Desculpe ${message.author.tag}, mas você sabe com certeza que ${user.tag} é um dos meus desenvolvedores, então por que eu iria bloquear ele?`)
