...
class Spotify extends erela_js_1.Plugin {
  ...
  getAlbumTracks(id) {
      return __awaiter(this, void 0, void 0, function* () {
          const {
              data: album
          } = yield axios_1.default.get(`${BASE_URL}/albums/${id}`, this.axiosOptions);
          ...
          while (next && !this.options.playlistLimit ? true : page < this.options.albumLimit) {
              const {
                  data: nextPage
              } = yield axios_1.default.get(next, this.axiosOptions);
  ...
  getPlaylistTracks(id) {
      return __awaiter(this, void 0, void 0, function* () {
          const {
              data: playlist
          } = yield axios_1.default.get(`${BASE_URL}/playlists/${id}`, this.axiosOptions);
  ...
  getTrack(id) {
      return __awaiter(this, void 0, void 0, function* () {
          const {
              data
          } = yield axios_1.default.get(`${BASE_URL}/tracks/${id}`, this.axiosOptions);
