...
class Deezer extends erela_js_1.Plugin {
    ...
    getAlbumTracks(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const {
                data: album
            } = yield axios_1.default.get(`${BASE_URL}/album/${id}`);
            const tracks = album.tracks.data.map(item => Deezer.convertToUnresolved(item));
            return {
                tracks: tracks.splice(0, this.options.albumLimit),
                name: album.title
            };
        });
    };
    getPlaylistTracks(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const {
                data: playlist
            } = yield axios_1.default.get(`${BASE_URL}/playlist/${id}`);
            const tracks = playlist.tracks.data.map(item => Deezer.convertToUnresolved(item));
            return {
                tracks: tracks.splice(0, this.options.playlistLimit),
                name: playlist.title
            };
        });
    };
    getTrack(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const {
                data
            } = yield axios_1.default.get(`${BASE_URL}/track/${id}`);
