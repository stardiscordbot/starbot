module.exports = {
  ...
  ship: {
    ...
    d1: 'you 2 of them are not compatible, they are very different from each other. 😔',
    d2: "you may be friends, but I don't see a better future between them, they you are similar to each other. 🤝",
    d3: 'you can be a couple, tastes are almost the same, you know each other a lot. 👀',
    d4: 'are perfect, made for each other, go ahead, you have everything to work out! ❤️'
  },
  userinfo: {
    inf: 'Information:',
    tag: 'Tag of: ',
  ...
  baninfo: {
    user: 'User:',
    reason: 'Reason:',
    desban: 'To unban, addReaction with 🐹.'
  },
  say: {
  ...
  pay: {
    noarg: 'Arguments are missing, use `%ppay <@​user | id> <amount>`',
  ...
  player: {
    ...
    solo: "😔 Unfortunately I was alone on the channel, I'm leaving",
  ...
  sugestao: {
    ...
    nova: '💡  »  New Suggestion',
    link: 'For everyone’s convenience, don’t send links for suggestions.',
  ...
  marry: {
    ...
    ja: 'already married, don’t worry, one hour you can do it.'
  },
  sobre: {
  ...
  welcome: {
    ...
    message: '%m welcome to the **%g** server, currently we have **%c** members! Hope you have fun with us ❤️'
  },
  leave: {
  ...
  image: {
    editando: '✍️ %u **|** editing',
    args: '✍️ %u **|** I need you to give me some argument so that I can edit',
    long: '✍️ %u **|** Your message is too long, try to reduce it to 300 characters',
    achivment: 'Achievement Unlocked!'
  },
  error: {
    dm: '❌ %u **|** I was unable to send the message in your dm, check if it is open or if I am blocked'
  },
  tradutor: {
